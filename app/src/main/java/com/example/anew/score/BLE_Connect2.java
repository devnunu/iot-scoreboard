...
public class BLE_Connect2 extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ble_connect2);
     ...
     * Service connection
     */
    private ServiceConnection mServiceConn2 = new ServiceConnection() {

        public void onServiceConnected(ComponentName className, IBinder binder) {
            Log.d(TAG, "Activity - Service connected");

            mService2 = ((BTCTemplateService.ServiceBinder) binder).getService();
    ...
    public void doStartService() {
        ...
        bindService(new Intent(this, BTCTemplateService.class), mServiceConn2, Context.BIND_AUTO_CREATE);
    }
    ...
    private void initialize() {
        ...
        mService2.setupService(mActivityHandler);

        // If BT is not on, request that it be enabled.
        // RetroWatchService.setupBT() will then be called during onActivityResult
        if(!mService2.isBluetoothEnabled()) {
    ...
    private void ensureDiscoverable() {
        if (mService2.getBluetoothScanMode() != BluetoothAdapter.SCAN_MODE_CONNECTABLE_DISCOVERABLE) {
        ...
        switch(requestCode) {
            case Constants.REQUEST_CONNECT_DEVICE:
                ...
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    if(address != null && mService2 != null)
                        mService2.connectDevice(address);
                }
                break;
        ...
        public void handleMessage(Message msg)
        {
            switch(msg.what) {
                ...
                case Constants.MESSAGE_BT_STATE_CONNECTED:
                    if(mService2 != null) {
                        String deviceName = mService2.getDeviceName();
                        if(deviceName != null) {
                            mTextStatus.setText(getResources().getString(R.string.bt_title) + ": " +
                        ...
                        intent = new Intent(BLE_Connect2.this, BLE_Setting.class);
                        startActivity(intent);
                    }
                    break;
